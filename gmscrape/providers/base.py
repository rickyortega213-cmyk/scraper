...
PLACE_FIELD_PATHS: dict[str, Sequence[str]] = {
    ...
    "place_id": ("place_id", "placeId", "google_id", "googleId", "id", "cid", "fid", "data_id"),
    ...
    "phone": ("phone", "phone_number", "phoneNumber", "formatted_phone_number",
              "international_phone_number", "nationalPhoneNumber", "telephone"),
    "website": ("website", "site", "url", "web", "website_url", "websiteUri", "domain"),
    ...
    "rating": ("rating", "reviews_rating", "average_rating", "stars", "score"),
    "reviews": ("reviews", "reviews_count", "reviewsCount", "user_ratings_total",
                "review_count", "userRatingCount", "ratings_total"),
